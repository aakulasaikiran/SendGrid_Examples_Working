...
public class GetSendGridDomain {
	public static void main(String[] args) throws IOException {
		/*try {
			SendGrid sg = new SendGrid("SG.DREulPO9TRmufQ1hQebdQg.ucFH9BSslfzdK-iCsDbP0v6lbLfIfv2ciXQqj1MpI");
			Request request = new Request();
			request.setMethod(Method.GET);
			
			request.addQueryParam("id","222054");
		...
		// GET /whitelabel/domains/{domain_id}
		    ...
		    try {
		    	SendGrid sg = new SendGrid("SG.DREulPO9TRmufQ1hQebdQg.ucFH9BSszdK-iCsvsDbP0v6lbLfIfv2ciXQqj1MpI");
				Request request = new Request();
		      request.setMethod(Method.GET);
